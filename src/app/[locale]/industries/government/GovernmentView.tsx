    ...
    const sections = [
        {
            ...
            imgGradient: "from-slate-500/20 to-gray-500/20",
            imgUrl: "/images/unsplash/photo-1582213782179-e0d53f98f2ca.jpg"
        },
        {
            id: "civic",
            icon: Building2,
            ...
            imgUrl: "/images/unsplash/photo-1555848962-6e79363ec58f.jpg"
        }
    ];
