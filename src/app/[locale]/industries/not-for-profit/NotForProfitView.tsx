...
import { Users, LineChart, CheckCircle2 } from "lucide-react";
import { motion } from "framer-motion";

export default function NotForProfitPage() {
    const t = useTranslations("NotForProfit");
    ...
    const sections = [
        {
            ...
            imgUrl: "/images/unsplash/photo-1469571486292-0ba58a3f068b.jpg"
        },
        {
            id: "analytics",
            icon: LineChart,
            ...
            imgUrl: "/images/unsplash/photo-1559028012-481c04fa702d.jpg"
        }
    ];
