...
import { Stethoscope, Video, CheckCircle2 } from "lucide-react";
import { motion } from "framer-motion";

export default function HealthServicesPage() {
    const t = useTranslations("HealthServices");
    ...
    const sections = [
        {
            ...
            imgGradient: "from-green-500/20 to-emerald-500/20",
            imgUrl: "/images/unsplash/photo-1530497610245-94d3c16cda28.jpg"
        },
        {
            id: "telemedicine",
            icon: Video,
            color: "text-teal-500",
            imgGradient: "from-teal-500/20 to-cyan-500/20",
            imgUrl: "/images/unsplash/photo-1576091160399-112ba8d25d1d.jpg"
        }
    ];
            ...
            <div className="container mx-auto px-4 py-10 space-y-10">
                {sections.map((section, index) => (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className={`flex flex-col ${index % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-8 lg:gap-8`}
                    >
                        {/* Text Content */}
