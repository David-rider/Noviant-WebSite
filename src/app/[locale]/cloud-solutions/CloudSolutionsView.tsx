...
import { Cloud, Layers, Lock, CheckCircle2 } from "lucide-react";
import { motion } from "framer-motion";

export default function CloudSolutionsPage() {
    const t = useTranslations("CloudSolutions");
    ...
    const sections = [
        ...
        },
        {
            ...
            imgUrl: "/images/unsplash/photo-1451187580459-43490279c0fa.jpg"
        },
        {
            id: "protection",
            icon: Lock,
